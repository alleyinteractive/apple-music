...
/* unused harmony default export */ var _unused_webpack_default_export = (registerBlockType('apple-music/demo', {
  ...
  description: __('How to Apple Music.', 'apple-music'),
  category: 'embed',
  icon: 'format-audio',
  keywords: [__('How to', 'apple-music'), __('Example', 'apple-music'), __('RichText', 'apple-music')],
  supports: {
    html: false
  },
  attributes: {
  ...
  edit: function edit() {
    return wp.element.createElement(
      ...
      wp.element.createElement(
        'h2',
        null,
        __('Call to Action', 'apple-music')
      )
    );
  },
  save: function save() {
    return window.wp.element.createElement('hr');
  }
}));
