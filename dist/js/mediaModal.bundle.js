...
media.view.MediaFrame.Post = postFrame.extend({
  initialize: function initialize() {
    ...
    var tabKeys = babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(appleMusic.tabs);
...
media.controller.AppleMusic = media.controller.State.extend({
  initialize: function initialize(options) {
    ...
    var tabKeys = babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(options.tabs);
    for (var i = 0, len = tabKeys.length; i < len; i += 1) {
      var tab = tabKeys[i];
...
__webpack_require__(/*! ./src/media-modal/media-modal.js */"./src/media-modal/media-modal.js");
module.exports = __webpack_require__(/*! ./src/media-modal/media-modal.css */"./src/media-modal/media-modal.css");
