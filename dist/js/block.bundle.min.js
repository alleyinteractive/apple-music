...
var ResultsWrapper = function (_Component) {
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(ResultsWrapper, [{
    ...
    value: function getResponse(type, term) {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_8__api__["c" /* searchCatalog */])(term, type, this.state.limit).then(function (data) {
      ...
      return wp.element.createElement(
        ...
        0 !== this.state.data.length && wp.element.createElement(
          ...
          wp.element.createElement(
            ...
            wp.element.createElement(
              'span',
              { className: __WEBPACK_IMPORTED_MODULE_10__resultsWrapper_css___default.a.viewLabel },
