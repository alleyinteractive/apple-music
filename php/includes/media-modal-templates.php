...
function sidebar() {
	...
	<script type="text/html" id="tmpl-apple-music-sidebar">
		...
		<form action="#" class="clearfix">
			...
			<p><input type="radio" name="format" value="badge" id="badge"><label for="badge"><img src="<?php echo PLUGIN_DIR_URL . 'assets/images/badge.svg'; ?>" alt=""/></label></p>
			<p><input type="radio" name="format" value="text-lockup" id="text-lockup"><label for="text-lockup"><img src="<?php echo PLUGIN_DIR_URL . 'assets/images/text-lockup.svg'; ?>" alt=""/></label></p>
			<p><input type="radio" name="format" value="app-icon" id="app-icon"><label for="app-icon"><img src="<?php echo PLUGIN_DIR_URL . 'assets/images/app-icon.svg'; ?>" alt=""/></label></p>
